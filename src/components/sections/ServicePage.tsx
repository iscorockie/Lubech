...
import { PROCESS, SERVICES, STATS } from "@/data/site";
import { staggerContainer, viewportReplay } from "@/lib/animations";

/**
 * Dedicated page for one service from the "What we build" section —
 * rendered by /webdevelopment, /mobileapps and /backendsystems.
 */
  ...
  return (
    <>
      ...
      <main id="main" className="relative">
        ...
        <section className="relative overflow-hidden py-24 md:py-32">
          ...
          <div className="container-x relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              >
                {service.pageIntro ?? service.description}
              </motion.p>
          ...
          <div className="container-x relative">
            ...
            >
              {service.features.map((f) => (
                <GlowCard key={f} className="flex items-center gap-4 p-6">
                  ...
                  <p className="text-sm font-semibold text-white/80">{f}</p>
                </GlowCard>
              ))}
            </motion.div>
          </div>
        ...
        {/* CTA */}
        <section aria-labelledby="service-cta-title" className="relative overflow-hidden py-24 md:py-32">
          <div className="hairline absolute inset-x-[10%] top-0" aria-hidden />
