    ...
    >
      ...
      <motion.div style={{ y: contentY, opacity: contentOpacity }} className="container-x relative">
        ...
        >
          ...
          <div
            aria-hidden
            className="absolute inset-x-10 -bottom-6 h-24 rounded-full bg-gradient-to-r from-blue-600/40 via-sky-500/40 to-cyan-400/40 blur-3xl"
          />

          <div className="animate-float relative rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-2 shadow-[0_30px_100px_-30px_rgba(37,99,235,0.6)] backdrop-blur-2xl">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {pillars.map(({ icon: Icon, label, note }, i) => (
                  <motion.div
                    ...
                    className={
                      i === 1
                        ? "rounded-2xl border border-sky-400/30 bg-gradient-to-b from-sky-500/[0.14] to-blue-600/[0.08] p-4 text-left shadow-[0_0_40px_-12px_rgba(14,165,233,0.7)]"
          ...
          <motion.div
            ...
            className="glass absolute -left-28 top-16 hidden rounded-2xl px-4 py-3 text-left shadow-[0_0_30px_-8px_rgba(37,99,235,0.8)] xl:block"
          ...
          <motion.div
            ...
            className="glass absolute -right-28 bottom-16 hidden rounded-2xl px-4 py-3 text-left shadow-[0_0_30px_-8px_rgba(6,182,212,0.8)] xl:block"
